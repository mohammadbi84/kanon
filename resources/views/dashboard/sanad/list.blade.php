        ...
        <div class="widget-content widget-content-area br-6">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="/dashboard/group/list/{{$khoshe->id}}">گروه {{$reshte->name}}</a></li>
                  <li class="breadcrumb-item active" aria-current="page">سند حرفه ها</li>
                </ol>
              </nav>
            <div class="widget-header">
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <h6> افزودن سند حرفه جدید به {{$reshte->name}}</h6>
                    </div>
                </div>
            </div>
            <div class="col-md-12 ">
                <form action="{{route('sanad.addpost', ['id' => $reshte->id])}}" method="post" enctype="multipart/form-data">
                    @CSRF
                    <div class="row">
                        <div class="col-md-4">
