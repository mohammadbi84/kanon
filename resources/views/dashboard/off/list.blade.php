            ...
            <div class="widget-header">
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <h6>افزودن تخفیف جدید</h6>
                    </div>
                </div>
            </div>
            <div class="col-md-8 offset-md-2">
                <form action="{{route('off.addpost')}}" method="post">
                    @CSRF
                    ...
                    <div class="input-group mb-4">
                        ...
                        <input type="text" class="form-control" name="value" aria-label="Username">
                    ...
                    <div class="input-group mb-4">
                        ...
                        <select name="type" type="text" class="form-control"  aria-label="Username">
                            ...
                            <option value="2" @if(old('type')==2) selected @endif>مبلغ</option>
                        </select>
                    </div>
            ...
            <div class="table-responsive mb-4 mt-4">
                <table id="default-ordering" class="table table-hover" style="width:100%">
                    ...
                    <tr>
                        <td>{{$key+1}}</td>
                        <td>{{$off->name}}</td>
                        <td>{{$off->value}}{{$off->type_name}}</td>

                        <td class="text-center">
                          <div>
                            <a href="{{route('off.edit',['id'=>$off->id])}}" class="btn btn-primary">مشاهده و ویرایش</a>
                            <a href="{{route('off.delete',['id'=>$off->id])}}" class="btn btn-danger">حذف</a>
                          </div>
