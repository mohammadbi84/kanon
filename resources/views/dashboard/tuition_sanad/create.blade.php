    ...
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        <div class="widget-content widget-content-area br-6">
            ...
            <nav aria-label="breadcrumb">
              ...
              <br>
            <form action="{{ route('tuition_sanad.store') }}" method="POST">
                @csrf
                <div class="form-group">
                    <label>سال</label>
                    <input type="text" name="year" class="form-control" placeholder="1403/1/1">
                </div>
                <div class="form-group">
                    <label>نام سند حرفه</label>
                    <select name="sanad_id" class="js-example-basic-single form-control" style="flex-grow: 1;">
                        @foreach($herfes as $herfe)
                            <option value="{{ $herfe->id }}">{{ $herfe->title }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    <label>کد استاندارد</label>
                ...
                <div class="form-group">
                    <label> مبلغ شهریه حضوری</label>
                    <input type="number" name="in_person_fee" class="form-control">
                </div>
                <div class="form-group">
                    <label>مبلغ شهریه مجازی</label>
                    <input type="number" name="online_fee" class="form-control">
                </div>
                <div class="form-group">
                    <label>مبلغ شهریه الکترونیکی</label>
                    <input type="number" name="electronic_fee" class="form-control">
                </div>
