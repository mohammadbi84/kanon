    ...
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        <div class="widget-content widget-content-area br-6">
            ...
            <div class="widget-header">
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <h6> افزودن حرفه جدید </h6>
                    </div>
                </div>
            </div>
            <div class="col-md-12 ">
                <form action="{{route('herfe.addpost')  }}" method="post" enctype="multipart/form-data">
                    @CSRF
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-4">
                                ...
                                <select name="reshte" class="js-example-basic-single form-control" style="flex-grow: 1;"
                                    id="">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-4">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="basic-addon5">نام استاندارد(حرفه) <span class="text-danger">*</span></span>
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-4">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">کد استاندارد قدیم <span class="text-danger">*</span></span>
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-4">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">کد استاندارد جدید <span class="text-danger">*</span></span>
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-4">
                                ...
                                <input class="form-control" onchange="timecalc()" onkeyup="timecalc()" name="teory_min" placeholder="دقیقه"
                                    id="teory_min" type="number" max="59" min="0" step="1" /><span
                                    style="font-size: 20px">:</span><input name="teory_hour" id="teory_hour" placeholder="ساعت"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-4">
                                ...
                                <input class="form-control" onchange="timecalc()" onkeyup="timecalc()" name="amali_min" placeholder="دقیقه"
                                    id="amali_min" type="number" max="59" min="0" step="1" /><span
                                    style="font-size: 20px">:</span><input name="amali_hour" id="amali_hour" placeholder="ساعت"
                                    class="form-control" type="number" min="0" step="1" onchange="timecalc()"
                                    onkeyup="timecalc()" />
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-4">
                                ...
                                <input class="form-control" onchange="timecalc()" onkeyup="timecalc()" name="karvarzi_min" placeholder="دقیقه"
                                    id="karvarzi_min" type="number" max="59" min="0" step="1" /><span
                                    style="font-size: 20px">:</span><input name="karvarzi_hour" id="karvarzi_hour" placeholder="ساعت"
                                    class="form-control" type="number" min="0" step="1" onchange="timecalc()"
                                    onkeyup="timecalc()" />
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-4">
                                ...
                                <input onchange="timecalc()" onkeyup="timecalc()" class="form-control" name="project_min" placeholder="دقیقه"
                                    id="project_min" type="number" max="59" min="0" step="1" /><span
                                    style="font-size: 20px">:</span><input name="project_hour" id="project_hour" placeholder="ساعت"
                                    class="form-control" type="number" min="0" step="1" onchange="timecalc()"
                                    onkeyup="timecalc()" />
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-4">
                                ...
                                <input class="form-control" id="sum_min" name="sum_min" type="number" min="0" step="1"  placeholder="دقیقه"
                                    readonly />
                                <span style="font-size: 20px">:</span>
                                <input name="sum_hour" id="sum_hour" class="form-control" type="number" min="0" step="1"placeholder="ساعت"
                                    readonly />
                            </div>
                        </div>
                        <script>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-4">
                                ...
                                <select name="kardanesh" class="form-control" id="">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group mb-4">
                                ...
                                <select name="madrak" class="form-control" id="">
            ...
            <div class="table-responsive mb-4 mt-4">
                        ...
                        <form id="bulk-delete-form" method="POST" action="{{ route('herfe.bulk-delete') }}">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{route('herfe.edit', ['id' => $item->id])}}" class="btn btn-primary">ویرایش</a>
                                    <a href="{{route('herfe.delete', ['id' => $item->id])}}" class="btn btn-danger">حذف</a>
                                    <a class="btn btn-secondary" type="button" data-toggle="modal" data-target="#item{{$item->id}}">
                                        جزئیات
                                    </a>
                                </td>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        <div class="border rounded p-3 h-100">
                                                            ...
                                                            <a href="/{{ $item->file }}" class="btn btn-secondary btn-block mb-2">دانلود فایل استاندارد</a>
                                                            <a href="/{{ $item->pic }}" class="btn btn-success btn-block mb-2">دانلود عکس استاندارد</a>
                ...
                <button type="submit" form="bulk-delete-form" class="btn btn-danger mt-2">حذف انتخاب‌شده‌ها</button>
                <script>
