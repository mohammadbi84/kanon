...
@section('content')
    ...
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        <div class="widget-content widget-content-area br-6">
                    ...
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <h6>
                            @if (Auth::user() && Auth::user()->hasRole('admin'))
                                ادمین
                            @elseif(Auth::user() && Auth::user()->hasRole('organ'))
                                اموزشگاه
                            @endif
                        </h6>
                    </div>
            ...
            @if (Auth::user() && Auth::user()->hasRole('organ'))
                @if ($organ && $organ->status == '3')
                    <p class="text-warning">پیام مدیر :{{ $organ->ReferenceText }}</p>
                    <form action="/dashboard/referral_update/{{ $organ->id }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" value=" {{ $organ->sodor_num }}" class="form-control"
                                        name="sodor_num" aria-label="Username">
                            ...
                            <div class="col-6">
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" value="{{ $organ->sodor_start }}" class="form-control"
                                        name="sodor_start" aria-label="Username" id="datepicker1">
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" value="{{ $organ->sodor_end }}" class="form-control datepicker"
                                        name="sodor_end" aria-label="Username">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group mb-4 form-label-group in-border">
                                    ...
                                    <input type="radio" id="haghighi" onclick="haghighi2()" checked
                                        class="form-check-input" name="tabsare34" aria-label="Username">
                            ...
                            <div class="col-6">
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" value=" {{ $moases->name }}" class="form-control"
                                        name="modir_name" aria-label="Username">
                            ...
                            <div class="col-6">
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" value="{{ $moases->family }} " class="form-control"
                                        name="modir_family" aria-label="Username">
                            ...
                            <div class="col-6">
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" value="{{ $moases->shenasname }} " class="form-control"
                                        name="modir_shenasname" aria-label="Username">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group mb-4 form-label-group in-border">
                                    ...
                                    <select type="text" class="form-select" name="modir_gender" id="modir_gender"
                                        aria-label="Username">
                                        <option value="">----</option>
                                        <option @if ($moases->gender == 1) selected @endif value="1">مرد
                                        </option>
                                        <option @if ($moases->gender == 2) selected @endif value="2">زن
                                        </option>
                                    </select>
                            ...
                            <div class="col-6">
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" value="{{ $moases->father }}" class="form-control"
                                        name="modir_father" aria-label="Username">
                            ...
                            <div class="col-6">
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" value="{{ $moases->birthday }}"
                                        class="form-control datepicker" name="modir_birthday" aria-label="Username">
                            ...
                            <div class="col-6">
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" value="{{ $moases->sadere }}" class="form-control"
                                        name="modir_sodor" aria-label="Username">
                            ...
                            <div class="col-6">
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" value="{{ $organ->hoghoghi_name }}" class="form-control"
                                        name="hoghoghi_name" aria-label="Username">
                            ...
                            <div class="col-6">
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" value="{{ $organ->hoghoghi_sabt }}" class="form-control"
                                        name="hoghoghi_sabt" aria-label="Username">
                            ...
                            <div class="col-6">
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" value="{{ $organ->hoghoghi_modir }}" class="form-control"
                                        name="hoghoghi_modir" aria-label="Username">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group mb-4 form-label-group in-border">
                                    ...
                                    <select type="text" class="form-select" name="city" id="city"
                                        aria-label="Username" value="{{ old('city') }}">
                            ...
                            <div class="col-6">
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" value="{{ $organ->postal }}" class="form-control"
                                        name="postal" aria-label="Username">
                            ...
                            <div class="col-6">
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" value="{{ $organ->tel }}" class="form-control"
                                        name="tel" aria-label="Username">
                            ...
                            <div class="col-6">
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" value="{{ $organ->fax }}" class="form-control"
                                        name="fax" aria-label="Username">
                            ...
                            <div class="col-6">
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" value="{{ $organ->mobile }}" class="form-control"
                                        name="mobile" aria-label="Username">
                            ...
                            <div class="col-6">
                                <label>لوگو</label>
                                @if ($organ->file_logo)
                                    <img src="{{ asset($organ->file_logo) }}" alt="Logo" class="img-thumbnail mb-2"
                                        width="100">
                                @endif
                            ...
                            <div class="col-6">
                                ...
                                @if ($organ->file_tasis)
                                    <img src="{{ asset($organ->file_tasis) }}" alt="Tasis" class="img-thumbnail mb-2"
                                        width="100">
                                @endif
                            ...
                            <div class="col-6">
                                ...
                                @if ($organ->file_moases)
                                    <img src="{{ asset($organ->file_moases) }}" alt="Moases"
                            ...
                            <div class="col-6">
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" value="{{ $organ->site }}" class="form-control"
                                        name="site" aria-label="Username">
                            ...
                            <div class="col-6">
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" value="{{ $organ->email }}" class="form-control"
                                ...
                                @foreach ($socials as $social)
                                    <div class="col-6">
                                        <div class="input-group mb-4">
                                            ...
                                            <input type="text" value="{{ $social->value }}" class="form-control"
                                                name="{{ $social->id }}" aria-label="Username">
                            ...
                            @foreach ($herfes as $herfe)
                                <div class="col-md">
                                    ...
                                    <input type="checkbox" name="herfe[{{ $herfe->id }}]"
                                        value="{{ $herfe->id }}" @if ($herfe->ok == 1) checked @endif>
                                </div>
                            @endforeach
                        </div>
                        <div class="col-6">
                ...
                @elseif($organ->status == '1' || $organ->status == '4')
                    ...
                    @if (!Auth::user()->password)
                        <div class="row">
                            <div class="col-md-6">
                                <form action="{{ route('set_password', ['id' => Auth::user()->id]) }}" method="post">
                                    @csrf
                                    <p class="form-p mb-2 mt-5 pb-0 ">لطفا برای خود یک رمز ورود تعیین کنید</p>
                                    <div class="input-group mt-4">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon5">رمز عبور</span>
                                        </div>
                                        <input type="password" class="form-control" name="password" id="password"
                                            aria-label="Username" value="{{ old('password') }}">
                                    </div>
                    ...
                    @else
                        <div class="row">
                            <div class="col-md-6">
                                <form action="{{ route('buying') }}" method="post">
                                    @csrf
                                    <p class="form-p mb-2 mt-5 pb-0 ">لطفا برای دسترسی به امکانات پنل هزینه عضویت را پرداخت
                                        کنید</p>
                                    <p class="form-p mb-2 mt-2 pb-0 ">مبلغ عضویت : 100,000 تومان</p>
                                    <button type="submit" class="btn btn-primary mt-3 mb-2 border py-2 rounded-3 w-50">
                                        پرداخت هزینه عضویت
                                    </button>
                                </form>
                            </div>
