...
<head>
    ...
    <style>
        ...
        .btn-news {
            ...
            /* تغییر شکل برای گرد کردن دو راس جلو (راست) */
            /* border-radius: 20px; */
...
<body>
            ...
            <div class="container top-slider-thumbs-container">
                <div class="top-slider-thumbs">
                    ...
                    @foreach ($sliders as $key => $slider)
                        <div class="item border-start border-4" style="border-color: #eba607 !important;"
                            data-index="{{ $key }}">
                            <img src="{{ asset($slider->image) }}" class="img" alt="">
                            <div>
                                <span>{{ $slider->name }}</span>
                                ...
                                <span style="font-size: 14px;color: #ffffffb2;">
                                    <svg fill="#ffffffb2" width="20px" height="20px" viewBox="0 0 24 24"
    ...
    <main>
        ...
        <div id="search-bar" class="container mt-3">
            <form action="/schools" method="get" class="search-bar text-bold-2" autocomplete="false">
                @csrf
                <div class="row">
                    {{-- <div class="col position-relative form-floating">
                        <input type="text" class="form-control" id="name" placeholder="نام آموزشگاه" name="name">
                        <label for="name" class="form-label ms-2">نام آموزشگاه</label>
                    </div> --}}

                    <div class="col input-group mb-4 form-label-group in-border">
                        <input type="text" class="form-control" name="name" id="name" placeholder="a">
                        <label for="">نام آموزشگاه</label>
                    </div>
                    ...
                    <div class="col">
                        <fieldset>
                            ...
                            <select name="state" id="state" class="form-select form-select-sm">
                                                      <option value="31" selected>یزد</option>
                                                  </select>
                           </fieldset>
                    </div>
                    ...
                    <div class="col">
                        <fieldset class="text-white">
                            ...
                            {{-- <label for="city" class="form-label ms-2">استان</label> --}}
                        </fieldset>
                    ...
                    <div class="col position-relative form-floating">
                        ...
                        <label for="state" class="form-label ms-2">شهرستان</label>
                    </div>


                    <div class="col position-relative form-floating">
                        <select name="group" id="group" class="form-select form-select-sm">
                            <option value="" selected>رشته</option>
                            @foreach ($groups as $group)
                                <option value="{{ $group->id }}">{{ $group->name }}</option>
                            @endforeach
                        </select>
                        <label for="group" class="form-label ms-2">رشته</label>
                    </div>
                    ...
                    <div class="col position-relative form-floating">
                        <select name="herfe" id="herfe" class="form-select form-select-sm">
                            <option value="" selected>حرفه</option>
                            @foreach ($herfes as $herfe)
                                <option value="{{ $herfe->id }}">{{ $herfe->name }}</option>
                            @endforeach
                        </select>
                        <label for="herfe" class="form-label ms-2">حرفه</label>
                    </div>
                    {{-- <div class="col position-relative">
                        <select name="herfe" id="herfe" class="form-select form-select-sm">
                            <option value="" selected>حرفه</option>
                    ...
                    <div class="col-auto">
                        <button type="button" id="show-map-button"
                            ...
                            <span>آموزشگاه‌ها از روی نقشه</span>
                        </button>
    ...
    <a href="#" id="btn-news" class="btn-news">
        <img src="{{ asset('akhbar.png') }}" alt="akhbar" width="30" height="120">
    </a>
                ...
                if (cityId) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('#state').append(
                                '<option value="">شهرستان</option>'); // گزینه پیشفرض
