                    ...
                    <tbody>
                        @foreach ($schools as $key=> $item)
                            <tr class="text-center">
                                ...
                                <td>
                                    <!-- آیکون حرفه‌ها -->
                                    <a href="#" class="btn btn-link"><i class="bi bi-briefcase"></i></a>
                    
                                    <!-- آیکون موقعیت جغرافیایی (نقشه) -->
                                    <a href="{{ route('school.show', ['id' => $item->id]) }}#map" class="btn btn-link">
                                        <i class="bi bi-geo-alt"></i>
                                    </a>
                                                        
                                    <!-- آیکون جزئیات -->
                                    <a href="{{route('school.show', ['id' => $item->id])}}" class="btn btn-link"><i class="bi bi-info-circle"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
