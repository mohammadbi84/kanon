            ...
            <div class="row row-cols-center">
                ...
                <div class="col-md-8 rounded-3 bg-white shadow">
                    ...
                    <div class="row rounded-4 p-3 pb-0">
                        <div class="d-flex flex-wrap align-content-center align-items-center mb-2 register_title">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="autocomplete @if (old('export_number')) filled @endif"
                                ...
                                <span class="clear-btn" id="clearBtn_export_number" onclick="clearInput('export_number')"
                        ...
                        <div class="row px-0 mx-0 mt-2 " id="haghighi-form"
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="autocomplete @if (old('natural_birth_date')) filled @endif"
                                    ...
                                    <input type="text" id="searchInputnatural_birth_date" name="natural_birth_date"
                                        readonly value="{{ old('natural_birth_date') }}"
                                ...
                                <div class="d-flex gap-0">
                                    ...
                                    <div class="autocomplete flex-grow-1 @if (old('founder_phone')) filled @endif"
                                        ...
                                        <input type="text" id="searchInputfounder_phone"
                                            ...
                                            maxlength="8" @error('founder_phone') style="border:red solid 1px" @enderror>
                                ...
                                <div class="d-flex gap-0">
                                    ...
                                    <div class="autocomplete flex-grow-1 @if (old('founder_phone2')) filled @endif"
                                        ...
                                        <input type="text" id="searchInputfounder_phone2"
                                            class="only-number validate-input" data-rule="phone" name="founder_phone2"
                                            maxlength="8" value="{{ old('founder_phone2') }}"
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="autocomplete @if (old('postal_code')) filled @endif"
                                ...
                                <input type="text" id="searchInputpostal_code" class="" name="postal_code"
                                    value="{{ old('postal_code') }}" oninput="formatPostalCode(this)" maxlength="11"
                                    @error('postal_code') style="border:red solid 1px" @enderror>
                            ...
                            <div class="d-flex gap-0">
                                ...
                                <div class="autocomplete flex-grow-1 @if (old('phone')) filled @endif"
                                    ...
                                    <input type="text" id="searchInputphone" class="only-number validate-input"
                                        data-rule="phone" name="phone" value="{{ old('phone') }}" maxlength="8"
                                        oninput="nameinput('phone')"
                                ...
                                <div class="autocomplete flex-grow-0 @if (old('phone_prefix')) filled @endif"
                                    ...
                                    <input type="text" id="searchInputphone_prefix" class="only-number validate-input"
                                        data-rule="prefix" name="phone_prefix" maxlength="3"
                                        value="{{ old('phone_prefix') }}" oninput="nameinput('phone_prefix')"
                                ...
                                <div class="col-md-12 mb-2">
                                    <div class="mb-3 p-2 rounded-3" style="background-color: #f2f7ff">
                                        ...
                                        <div
                                            ...
                                            <label for="file_tasis_front" class="btn btn-primary ms-2">انتخاب
                                                فایل</label>
                                ...
                                <div class="col-md-12 mb-2">
                                    <div class="mb-3 p-2 rounded-3" style="background-color: #f2f7ff">
                                        ...
                                        <div
                                            ...
                                            <label for="file_tasis_back" class="btn btn-primary ms-2">انتخاب
                                                فایل</label>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3 p-2 rounded-3" style="background-color: #f2f7ff">
                                        ...
                                        <div
                                            ...
                                            <span id="fileCountText" class="ms-2 text-primary">فایلی انتخاب
                                                نشده</span>
                                            <!-- نمایش لیست فایل‌ها -->
                                        </div>
                    ...
                    <!-- دکمه ارسال -->
                    <div class="row text-center justify-content-center rounded-4 p-4 pt-1 g-0">
                                ...
                                <div class="col">
                                    <div class="autocomplete @if (old('captcha')) filled @endif"
                                        ...
                                        <input type="text" id="searchInputcaptcha" class="only-number" name="captcha"
                                            ...
                                            @error('captcha') style="border:red solid 1px" @enderror>
    ...
    <script>
        ...
        function updateFileList() {
            ...
            selectedFiles.forEach((file, index) => {
                ...
                html += `
            <div class="d-flex align-items-center justify-content-between mb-2 border bg-white p-2 rounded position-relative">
