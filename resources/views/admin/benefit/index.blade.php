...
@section('content')
    ...
    <div class="card">
        <div class="card-datatable table-responsive pt-0 p-3">
            <table class="dt-select-table benefit table">
                <thead>
                    <tr>
                        {{-- filled with ajax --}}
                    </tr>
            ...
            <div class="modal-content p-3 p-md-5">
                <div class="modal-body p-0">
                    ...
                    <div class="text-center mb-4 mt-0 mt-md-n2">
                        <h3 class="secondary-font">افزودن محتوای جدید</h3>
                    </div>
                    <form action="{{ route('admin.benefit.store') }}" method="post"
                        ...
                        <div class="col-sm-12">
                            <input type="hidden" name="text" id="body">
...
@section('script')
    ...
    <script>
        dt_basic = $('.benefit').DataTable({
            ...
            dom: '<"card-header flex-column flex-md-row"<"head-label text-center d-flex justify-content-between align-items-center w-100"><"dt-action-buttons text-end primary-font pt-3 pt-md-0"B>><"row"<"col-sm-12 col-md-6"l><"col-sm-12 col-md-6 d-flex justify-content-center justify-content-md-end"f>>t' +
        ...
        $("div.head-label").html(
            '<h5 class="card-title mb-0">مزایای گواهینامه های فنی حرفه ای</h5>' +
            '<button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createModal" >محتوای جدید</button>'
        );
        ...
        if (btnBulk) {
            ...
            btnBulk.on("click", function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "/admin2/benefit/bulk-delete",
                            type: "POST",
                            data: {
                                _token: $('meta[name="csrf-token"]').attr(
                                    "content"
