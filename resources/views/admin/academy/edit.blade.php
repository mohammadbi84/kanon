...
@section('content')
    <h5 class="breadcrumb-wrapper mb-4">
        ...
        <a href="#" class="text-muted">{{ $academy->name }}</a> <span class="text-muted">/</span>
                    ...
                    <div class="col">
                        ...
                        <div class="row rounded-4 p-3 pb-0">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="autocomplete @if (old('name',$academy->name)) filled @endif"
                                    id="autocompleteBoxname">
                                    <input type="text" id="searchInputname" class="only-persian" name="name"
                                        value="{{ old('name',$academy->name) }}" oninput="nameinput('name')"
                                        @error('name')
                                    ...
                                    <span class="clear-btn" id="clearBtn_name" onclick="clearInput('name')"
                                        @if (old('name',$academy->name)) style="display:block !important" @endif>×</span>
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="autocomplete @if (old('id_number',$academy->id_number)) filled @endif"
                                    id="autocompleteBoxid_number">
                                    <input type="text" id="searchInputid_number" class="only-number" name="id_number"
                                        value="{{ old('id_number',$academy->id_number) }}" oninput="nameinput('id_number')"
                                        @error('id_number')
                                    style="border:red solid 1px"
                                    @enderror>
                                    ...
                                    <span class="clear-btn" id="clearBtn_id_number" onclick="clearInput('id_number')"
                                        @if (old('id_number',$academy->id_number)) style="display:block !important" @endif>×</span>
                                </div>
                                @error('id_number')
                                    <small class="text-danger mt-2">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="autocomplete @if (old('export_number',$academy->export_number)) filled @endif"
                                    id="autocompleteBoxexport_number">
                                    <input type="text" id="searchInputexport_number" class="only-number-sign"
                                        name="export_number" value="{{ old('export_number',$academy->export_number) }}"
                                    ...
                                    <span class="clear-btn" id="clearBtn_export_number"
                                        ...
                                        @if (old('export_number',$academy->export_number)) style="display:block !important" @endif>×</span>
                                </div>
                                @error('export_number')
                                    <small class="text-danger mt-2">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="autocomplete @if (old('export_start',$academy->export_start)) filled @endif"
                                    id="autocompleteBoxexport_start">
                                    <input type="text" id="searchInputexport_start" name="export_start" readonly
                                        value="{{ old('export_start',$academy->export_start) }}" oninput="nameinput('export_start')"
                                        @error('export_start')
                                    style="border:red solid 1px"
                                    @enderror>
                                    ...
                                    <span class="clear-btn" id="clearBtn_export_start" onclick="clearInput('export_start')"
                                        @if (old('export_start',$academy->export_start)) style="display:block !important" @endif>×</span>
                                </div>
                                @error('export_start')
                                    <small class="text-danger mt-2">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="autocomplete @if (old('export_reset',$academy->export_reset)) filled @endif"
                                    id="autocompleteBoxexport_reset">
                                    <input type="text" id="searchInputexport_reset" name="export_reset" readonly
                                        value="{{ old('export_reset',$academy->export_reset) }}" oninput="nameinput('export_reset')"
                                        @error('export_reset')
                                    style="border:red solid 1px"
                                    @enderror>
                                    ...
                                    <span class="clear-btn" id="clearBtn_export_reset" onclick="clearInput('export_reset')"
                                        @if (old('export_reset',$academy->export_reset)) style="display:block !important" @endif>×</span>
                                </div>
                                @error('export_reset')
                                    <small class="text-danger mt-2">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="autocomplete @if (old('export_end',$academy->export_end)) filled @endif"
                                    id="autocompleteBoxexport_end">
                                    <input type="text" id="searchInputexport_end" name="export_end" readonly
                                        value="{{ old('export_end',$academy->export_end) }}" oninput="nameinput('export_end')"
                                        @error('export_end')
                                    style="border:red solid 1px"
                                    @enderror>
                                    ...
                                    <span class="clear-btn" id="clearBtn_export_end" onclick="clearInput('export_end')"
                                        @if (old('export_end',$academy->export_end)) style="display:block !important" @endif>×</span>
                                </div>
                                @error('export_end')
                                    <small class="text-danger mt-2">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="row">
                                        ...
                                        <div class="row g-0">
                                            <div class="col-1 p-1">
                                                <input type="radio" class="form-check-input" name="license"
                                                    id="parvane_first" {{ old('license',$academy->license) == 'first' ? 'checked' : '' }}
                                            ...
                                            <div class="col-1 p-1">
                                                <input type="radio" class="form-check-input" name="license"
                                                    id="parvane_tamdid"
                                                    {{ old('license',$academy->license) == 'extension' ? 'checked' : '' }} value="extension"
                                                    onchange="">
                                            </div>
                                            <div class="col-5 p-1">
                                    ...
                                    <div class="col-md-6">
                                        <div class="autocomplete @if (old('first_license_date',$academy->first_license_date)) filled @endif"
                                            id="autocompleteBoxfirst_license_date">
                                            <input type="text" id="searchInputfirst_license_date"
                                                name="first_license_date" readonly
                                                value="{{ old('first_license_date',$academy->first_license_date) }}"
                                            ...
                                            <span class="clear-btn" id="clearBtn_first_license_date"
                                                ...
                                                @if (old('first_license_date',$academy->first_license_date)) style="display:block !important" @endif>×</span>
                                        </div>
                                        @error('first_license_date')
                                            <small class="text-danger mt-2">{{ $message }}</small>
                                        @enderror
                                        ...
                                        <div class="d-flex flex-wrap align-content-center p-0">
                                            <div class="form-check form-check-inline ms-2 me-0" dir="rtl">
                                                <input type="radio" class="form-check-input" name="gender"
                                                    id="baradaran" {{ old('gender',$academy->gender) == 'male' ? 'checked' : '' }}
                                            ...
                                            <div class="form-check form-check-inline ms-2 me-0" dir="rtl">
                                                <input type="radio" class="form-check-input" name="gender"
                                                    id="khaharan" {{ old('gender',$academy->gender) == 'female' ? 'checked' : '' }}
                                            ...
                                            <div class="form-check form-check-inline ms-2 me-0" dir="rtl">
                                                <input type="radio" class="form-check-input" name="gender"
                                                    id="mokhtalet" {{ old('gender',$academy->gender) == 'both' ? 'checked' : '' }}
                                                    value="both" onchange="handleGenderChange()">
                                            </div>
                                            <label for="mokhtalet" class="form-check-label">برادران،خواهران <small>( دو
                                                    منظوره )</small></label>
                                        </div>
                                        <div class="d-flex flex-wrap align-content-center p-0">
                                            <div class="form-check form-check-inline ms-4 me-0" dir="rtl">
                                                <input type="checkbox" class="form-check-input" name="tabsare_34"
                                                    {{ old('gender',$academy->gender) == 'both' ? 'checked' : '' }} value="1"
                                ...
                                <select id="mySelect" class="form-select mb-0" multiple name="herfe[]"
                                    ...
                                    @foreach ($fields as $field)
                                        <option value="{{ $field->id }}"
                                            @if (old('herfe',$academy->fields) && in_array($field->id, old('herfe',$academy->fields()->get()->toArray()))) selected @endif>
                        ...
                        <div class="row rounded-4 p-3 pt-0 mt-0">
                            ...
                            <div class="d-flex flex-wrap align-content-center pe-0">
                                <div class="form-check form-check-inline me-2 me-0" dir="rtl">
                                    <input type="radio" name="haghighi" id="haghighi" value="1"
                                        class="form-check-input" {{ old('haghighi', ,$academy->haghighi) == 1 ? 'checked' : '' }}
                                        onclick="toggleForms()">
                                </div>
                                ...
                                <div class="form-check form-check-inline me-2" dir="rtl">
                                    <input type="radio" name="haghighi" id="hoghoghi" value="2"
                                        class="form-check-input" {{ old('haghighi',$academy->haghighi) == 2 ? 'checked' : '' }}
                                        onclick="toggleForms()">
                                </div>
                            ...
                            <div class="row px-0 mx-0 mt-2 " id="haghighi-form"
                                style="display:{{ old('haghighi',$academy->haghighi) == 1 ? '' : 'none' }}">
                                <div class="col-md-6 mb-3">
                                    <div class="autocomplete @if (old('natural_name',$academy->natural_name)) filled @endif"
                                        id="autocompleteBoxnatural_name">
                                        <input type="text" id="searchInputnatural_name" class="only-persian"
                                            name="natural_name" value="{{ old('natural_name',$academy->natural_name) }}"
                                    ...
                                    @enderror>
                                        ...
                                        <span class="clear-btn" id="clearBtn_natural_name"
                                            ...
                                            @if (old('natural_name',$academy->natural_name)) style="display:block !important" @endif>×</span>
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="autocomplete @if (old('natural_family',$academy->natural_family)) filled @endif"
                                        id="autocompleteBoxnatural_family">
                                        <input type="text" id="searchInputnatural_family" class="only-persian"
                                            name="natural_family" value="{{ old('natural_family',$academy->natural_family) }}"
                                    ...
                                    @enderror>
                                        ...
                                        <span class="clear-btn" id="clearBtn_natural_family"
                                            ...
                                            @if (old('natural_family',$academy->natural_family)) style="display:block !important" @endif>×</span>
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="autocomplete @if (old('natural_father',$academy->natural_father)) filled @endif"
                                        id="autocompleteBoxnatural_father">
                                        <input type="text" id="searchInputnatural_father" class="only-persian"
                                            name="natural_father" value="{{ old('natural_father',$academy->natural_father) }}"
                                    ...
                                    @enderror>
                                        ...
                                        <span class="clear-btn" id="clearBtn_natural_father"
                                            ...
                                            @if (old('natural_father',$academy->natural_father)) style="display:block !important" @endif>×</span>
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="autocomplete @if (old('national_code',$academy->national_code)) filled @endif"
                                        ...
                                        <input type="text" id="searchInputnational_code" data-rule="nationalCode"
                                            ...
                                            value="{{ old('national_code',$academy->national_code) }}" oninput="nameinput('national_code')"
                                            @error('national_code')
                                        style="border:red solid 1px"
                                    @enderror>
                                        ...
                                        <span class="clear-btn" id="clearBtn_national_code"
                                            ...
                                            @if (old('national_code',$academy->national_code)) style="display:block !important" @endif>×</span>
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="autocomplete @if (old('national_id_number',$academy->national_id_number)) filled @endif"
                                        id="autocompleteBoxnational_id_number">
                                        <input type="text" id="searchInputnational_id_number" class="only-number"
                                            name="national_id_number" value="{{ old('national_id_number',$academy->national_id_number) }}"
                                    ...
                                    @enderror>
                                        ...
                                        <span class="clear-btn" id="clearBtn_national_id_number"
                                            ...
                                            @if (old('national_id_number',$academy->national_id_number)) style="display:block !important" @endif>×</span>
                                    </div>
                                    @error('national_id_number')
                                        <small class="text-danger mt-2">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="autocomplete @if (old('natural_birth_date',$academy->natural_birth_date)) filled @endif"
                                        id="autocompleteBoxnatural_birth_date">
                                        <input type="text" id="searchInputnatural_birth_date"
                                            name="natural_birth_date" readonly value="{{ old('natural_birth_date',$academy->natural_birth_date) }}"
                                    ...
                                    @enderror>
                                        ...
                                        <span class="clear-btn" id="clearBtn_natural_birth_date"
                                            ...
                                            @if (old('natural_birth_date',$academy->natural_birth_date)) style="display:block !important" @endif>×</span>
                                    </div>
                                    @error('natural_birth_date')
                                        <small class="text-danger mt-2">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="autocomplete @if (old('natural_issue',$academy->natural_issue)) filled @endif"
                                        id="autocompleteBoxnatural_issue">
                                        <input type="text" id="searchInputnatural_issue" class="only-persian"
                                            name="natural_issue" value="{{ old('natural_issue',$academy->natural_issue) }}"
                                    ...
                                    @enderror>
                                        ...
                                        <span class="clear-btn" id="clearBtn_natural_issue"
                                            ...
                                            @if (old('natural_issue',$academy->natural_issue)) style="display:block !important" @endif>×</span>
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="d-flex gap-0">
                                        <!-- شماره اصلی -->
                                        <div class="autocomplete flex-grow-1 @if (old('founder_phone',$academy->founder_phone)) filled @endif"
                                            ...
                                            <input type="text" id="searchInputfounder_phone"
                                                ...
                                                value="{{ old('founder_phone',$academy->founder_phone) }}" oninput="nameinput('founder_phone')"
                                                maxlength="8"
                                            ...
                                            <span class="clear-btn" id="clearBtn_founder_phone"
                                                ...
                                                @if (old('founder_phone',$academy->founder_phone)) style="display:block !important" @endif>×</span>
                                        </div>
                                        <!-- پیش شماره -->
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="autocomplete @if (old('founder_mobile',$academy->founder_mobile)) filled @endif"
                                        ...
                                        <input type="text" id="searchInputfounder_mobile"
                                            ...
                                            name="founder_mobile" value="{{ old('founder_mobile',$academy->founder_mobile) }}"
                                    ...
                                    @enderror>
                                        ...
                                        <span class="clear-btn" id="clearBtn_founder_mobile"
                                            ...
                                            @if (old('founder_mobile',$academy->founder_mobile)) style="display:block !important" @endif>×</span>
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="autocomplete @if (old('founder_email',$academy->founder_email)) filled @endif"
                                        id="autocompleteBoxfounder_email">
                                        <input type="email" id="searchInputfounder_email" class=""
                                            name="founder_email" value="{{ old('founder_email',$academy->founder_email) }}"
                                    ...
                                    @enderror>
                                        ...
                                        <span class="clear-btn" id="clearBtn_founder_email"
                                            ...
                                            @if (old('founder_email',$academy->founder_email)) style="display:block !important" @endif>×</span>
                                    </div>
                                    @error('founder_email')
                                        <small class="text-danger mt-2">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="autocomplete @if (old('founder_address',$academy->founder_address)) filled @endif"
                                        id="autocompleteBoxfounder_address">
                                        <input type="text" id="searchInputfounder_address" class="only-persian"
                                            name="founder_address" value="{{ old('founder_address',$academy->founder_address) }}"
                                    ...
                                    @enderror>
                                        ...
                                        <span class="clear-btn" id="clearBtn_founder_address"
                                            ...
                                            @if (old('founder_address',$academy->founder_address)) style="display:block !important" @endif>×</span>
                                    </div>
                            ...
                            <div class="row px-0 mx-0 mt-2" id="hoghoghi-form"
                                style="display: {{ old('haghighi',$academy->haghighi) == 2 ? '' : 'none' }}">
                                <div class="col-md-6 mb-3">
                                    <div class="autocomplete @if (old('legal_company_name',$academy->legal_company_name)) filled @endif"
                                        id="autocompleteBoxlegal_company_name">
                                        <input type="text" id="searchInputlegal_company_name" class="only-persian"
                                            name="legal_company_name" value="{{ old('legal_company_name',$academy->legal_company_name) }}"
                                    ...
                                    @enderror>
                                        ...
                                        <span class="clear-btn" id="clearBtn_legal_company_name"
                                            ...
                                            @if (old('legal_company_name',$academy->legal_company_name)) style="display:block !important" @endif>×</span>
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="autocomplete @if (old('legal_register_number',$academy->legal_register_number)) filled @endif"
                                        id="autocompleteBoxlegal_register_number">
                                        <input type="text" id="searchInputlegal_register_number" class="only-number"
                                            name="legal_register_number" value="{{ old('legal_register_number',$academy->legal_register_number) }}"
                                    ...
                                    @enderror>
                                        ...
                                        <span class="clear-btn" id="clearBtn_legal_register_number"
                                            ...
                                            @if (old('legal_register_number',$academy->legal_register_number)) style="display:block !important" @endif>×</span>
                                    </div>
                                    @error('legal_register_number')
                                        <small class="text-danger mt-2">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="autocomplete @if (old('register_date',$academy->register_date)) filled @endif"
                                        id="autocompleteBoxregister_date">
                                        <input type="text" id="searchInputregister_date" name="register_date" readonly
                                            value="{{ old('register_date',$academy->register_date) }}" oninput="nameinput('register_date')"
                                            @error('register_date')
                                    style="border:red solid 1px"
                                    @enderror>
                                        ...
                                        <span class="clear-btn" id="clearBtn_register_date"
                                            ...
                                            @if (old('register_date',$academy->register_date)) style="display:block !important" @endif>×</span>
                                    </div>
                                    @error('register_date')
                                        <small class="text-danger mt-2">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="autocomplete @if (old('legal_manager',$academy->legal_manager)) filled @endif"
                                        id="autocompleteBoxlegal_manager">
                                        <input type="text" id="searchInputlegal_manager" class="only-persian"
                                            name="legal_manager" value="{{ old('legal_manager',$academy->legal_manager) }}"
                                    ...
                                    @enderror>
                                        ...
                                        <span class="clear-btn" id="clearBtn_legal_manager"
                                            ...
                                            @if (old('legal_manager',$academy->legal_manager)) style="display:block !important" @endif>×</span>
                                    </div>
