...
@section('content')
    <div class="card">
        <form action="{{ route('admin.categories.update', ['id' => $category->id]) }}" method="post" class="add-new-record row g-2 p-5"
            ...
            <div class="col-sm-12">
                ...
                <div class="input-group input-group-merge">
                    ...
                    <input type="text" id="name" class="form-control dt-full-name" name="name"
                        value="{{ old('name', $category->name) }}" placeholder="نام رسته" aria-label="John Doe"
