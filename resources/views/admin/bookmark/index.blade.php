...
@section('content')
    ...
    <div class="card">
        <div class="card-datatable table-responsive pt-0 p-3">
            <form action="{{ route('admin.bookmark.store') }}" method="post" class="add-new-record pt-0 row g-2 mt-3 px-3"
                ...
                <div class="col-sm-3">
                    <label class="form-label" for="duration">تایمر <small>به ثانیه</small></label>
            ...
            <table class="dt-select-table bookmark table">
                <thead>
                    <tr>
                        {{-- filled with ajax --}}
                    </tr>
...
@section('script')
    ...
    <script>
        dt_basic = $('.bookmark').DataTable({
            ajax: "/admin2/bookmark",
            columns: [{
                    data: "",
                    title: ""
        ...
        if (btnBulk) {
            ...
            btnBulk.on("click", function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "/admin2/bookmark/bulk-delete",
                            type: "POST",
                            data: {
                                _token: $('meta[name="csrf-token"]').attr(
                                    "content"
