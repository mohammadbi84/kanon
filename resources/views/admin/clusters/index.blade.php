...
@section('content')
    ...
    <h5 class="breadcrumb-wrapper mb-4 pt-4" style="padding: 15px 10px !important;" id="breadcrumb-wrapper">
        ...
        @if ($categoryId)
            <a href="{{ route('admin.categories.index') }}" class="text-muted">رسته {{ $category?->name }}</a> <span
        ...
        $(document).on("click", ".item-edit", function() {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    $("#modalEdit #category_id").val(res.data.category_id);
            ...
            initOffcanvasForm({
                ...
                onSubmit: function(values) {
                    ...
                    // ارسال Ajax
                    $.post("/admin2/clusters/update", values, function(res) {
                        if (res.success) {
                            toastr.success(res.message);
                        } else {
                            toastr.error(res.message);
                        ...
                        toastr.error("خوشه با این نام وجود دارد.");
                    });
                },
            });
        });
